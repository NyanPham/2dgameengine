#ifndef PROJECTEMITSYSTEM_H
#define PROJECTEMITSYSTEM_H
    ...
    public:
            ...
            if (event.symbol == SDLK_SPACE) {
                ...
                for (auto entity: GetSystemEntities()) {
                    if (entity.HasTag("player")) {
                        ...
                        // if parent entity direction is controlled by the keyboard keys, modify the 
        ...
        void Update(std::unique_ptr<Registry>& registry) {
            for (auto entity: GetSystemEntities()) {
                ...
                if (SDL_GetTicks() - projectileEmitter.lastEmissionTime > (unsigned int)projectileEmitter.repeatFrequency) {
                    glm::vec2 projectilePosition = transform.position;
                    if (entity.HasComponent<SpriteComponent>()) {
                    ...
                    // update the projectile emitter component last emission to the current millisecs
