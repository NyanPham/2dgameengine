    ...
    public:
        ...
        void Update(const std::unique_ptr<Registry>& registry, const SDL_Rect& camera) {
            ...
            if (ImGui::Begin("Spawn enemies")) {
                // static vars to hold input vals 
                static int posX = 0;
                static int posY = 0;
                static int scaleX = 1;
                static int scaleY = 1;
                ...
                // section to input enemy rigid body vals 
                ...
                // section to input enemy projectile emitter vals 
                ...
                // section to input enemy health vals 
                ...
                if (ImGui::Button("Create new enemy")) {
                    ...
                    // reset all input vals after we create a new enemy 
